...
(function() {
    ...
    Runner.prototype = {
        ...
        init: function() {
            ...
            this.distanceMeter.loadHigScore();
    ...
    DistanceMeter.prototype = {
        ...
        saveHighScore: function(distance){
          localStorage.setItem("HighDistance",distance);
        },

        loadHigScore: function(){
          var distance = localStorage.getItem("HighDistance");
